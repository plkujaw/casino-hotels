...
?>
    ...
    <link rel="preload" href="<?php echo esc_url(get_theme_file_uri('assets/fonts/Poppins-SemiBold.woff2')); ?>" as="font" type="font/woff2" crossorigin>
    ...
    <link rel="preload" href="<?php echo esc_url(get_theme_file_uri('assets/fonts/Jost-Light.woff2')); ?>" as="font" type="font/woff2" crossorigin>
<?php
  }
endif;
